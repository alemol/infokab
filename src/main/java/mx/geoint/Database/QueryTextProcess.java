...
public class QueryTextProcess {
    static String query_main_base = " " +
            " SELECT (base.clave) as clave, base.codigo as codigos, concat('(',base.clave,')') as result_left, concat(base.descripcion,'[',base.codigo,']') as result_right\n" +
            "    FROM bases as base\n" +
    ...
    static String query_main_base_with_one_suffixes = "" +
            ...
            "        SELECT base.clave as clave, base.codigo as base_code, base.codigo as codigos, concat('(',base.clave,')') as result_left, concat(base.descripcion,'[',base.codigo,']') as result_right\n" +
            "        FROM bases as base\n" +
            "        where ? like concat(base.clave,'%')\n" +
            "        and length(?) >= length(base.clave)\n" +
            "    ) base1\n" +
    ...
    static String query_main_prefixes_with_base = "" +
            " select concat(prefijo.clave,base.clave) as clave, concat(prefijo.codigos,'-',base.codigo) as codigos, concat(prefijo.result_left,'+','(',base.clave,')') as result_left, concat(prefijo.result_right,'+',base.descripcion,'[',base.codigo,']') as result_right\n" +
            "    FROM bases as base, (\n" +
            "        select p.clave as clave, p.codigo as codigos, p.clave as result_left, p.descripcion as result_right\n" +
            "        from prefijos p \n" +
            "        where ? like concat(p.clave,'%')\n" +
    ...
    static String query_main_prefixes_with_base_with_one_suffixes = " " +
            " select concat(base1.clave,sufijo1.clave) as clave, concat(base1.codigos,'-',sufijo1.codigo) as codigos, concat(base1.result_left,'+',sufijo1.clave) as result_left, concat(base1.result_right,'+',sufijo1.descripcion) as result_right\n" +
            "    from sufijos as sufijo1, (\n" +
            "        select concat(prefijo.clave,base.clave) as clave, base.codigo as base_code, concat(prefijo.codigos,'-',base.codigo) as codigos, concat(prefijo.result_left,'+','(',base.clave,')') as result_left, concat(prefijo.result_right,'+',base.descripcion,'[',base.codigo,']') as result_right\n" +
            "        FROM bases as base, (\n" +
            "            select p.clave as clave, p.codigo as codigos, p.clave as result_left, p.descripcion as result_right\n" +
            "            from prefijos p \n" +
            "            where ? like concat(p.clave,'%')\n" +
