...
public class TierMultiple {
    ...
    public String REF_ANNOTATION_ID_TRANSCRIPCION_LITERAL = "";
    ...
    public String REF_ANNOTATION_REF_ID_TRANSCRIPCION_LITERAL = "";
    ...
    public String ANNOTATION_VALUE_TRANSCRIPCION_LITERAL = "";
    ...
    public String ANNOTATION_VALUE_SOUNDEX_TRANSCRIPCION_LITERAL = "";
    public String ANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE = "";
    ...
    public String getANNOTATION_VALUE_TRANSCRIPCION_LITERAL() { return ANNOTATION_VALUE_TRANSCRIPCION_LITERAL; }

    public String getREF_ANNOTATION_ID_TRANSCRIPCION_LITERAL() { return REF_ANNOTATION_ID_TRANSCRIPCION_LITERAL; }

    public String getREF_ANNOTATION_REF_ID_TRANSCRIPCION_LITERAL() { return REF_ANNOTATION_REF_ID_TRANSCRIPCION_LITERAL; }
    ...
    public String getANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE() { return ANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE; }

    public void setANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE(String ANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE) { this.ANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE = ANNOTATION_VALUE_SOUNDEX_TRADUCCION_LIBRE; }
